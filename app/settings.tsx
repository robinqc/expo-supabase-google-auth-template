  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.header}>
        ...
        <Text variant="heading" weight="extrabold">{t("settings.title")}</Text>
      </View>
      ...
      <ScrollView style={layouts.flex1}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text variant="title" weight="semibold" style={styles.sectionTitle}>{t("settings.appearance")}</Text>
          </View>
        ...
        <View style={[styles.section, styles.borderTop]}>
          <View style={styles.sectionHeader}>
            ...
            <Text variant="title" weight="semibold" style={styles.sectionTitle}>{t("settings.privacy")}</Text>
          </View>
          <Text variant="body" color="secondary">
